...
/***/ function(module, exports, __webpack_require__) {
	...
	var AxiosServiceAdapter_1 = __webpack_require__(23);
	AxiosServiceAdapter_1.AxiosServiceConnector.configure({
	    baseURL: '/onphp-services/example/client/dist/data'
	});
	var catsService = new TestService_1.TestService(new AxiosServiceAdapter_1.AxiosServiceConnector());
	catsService.getList()
	    .then(function (list) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoCat_1 = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseStructure_1 = __webpack_require__(3);
	var Singleton_1 = __webpack_require__(5);
	var ProtoCat_1 = __webpack_require__(6);
	var AutoCat = (function (_super) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseStructure = (function () {
	    ...
	    BaseStructure.proto = function () {
	        throw new Exceptions_1.UnimplementedFeatureException();
	    };
...
/***/ function(module, exports) {
	...
	var BusinessLogicException = (function (_super) {
	...
	var WrongArgumentException = (function (_super) {
	...
	exports.WrongArgumentException = WrongArgumentException;
	var UnimplementedFeatureException = (function (_super) {
	...
	exports.UnimplementedFeatureException = UnimplementedFeatureException;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoProtoCat_1 = __webpack_require__(7);
	/**
	 * Created by klkvsk on 08.10.2016.
	 */
	var ProtoCat = (function (_super) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PrimitiveString_1 = __webpack_require__(8);
	var StructureProto_1 = __webpack_require__(11);
	var Form_1 = __webpack_require__(14);
	/**
	 * Created by klkvsk on 08.10.2016.
	 */
	var AutoProtoCat = (function (_super) {
	    ...
	    AutoProtoCat.prototype.getForm = function () {
	        return new Form_1.Form()
	            .add('name', new PrimitiveString_1.PrimitiveString()
	            .setRequired(true));
	    };
	    return AutoProtoCat;
	}(StructureProto_1.StructureProto));
	exports.AutoProtoCat = AutoProtoCat;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Primitive_1 = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var PrimitiveImportError_1 = __webpack_require__(10);
	var Primitive = (function () {
	    ...
	    Primitive.prototype.checkImportResult = function () {
	        if (this.required && !this.value) {
	            this.error = PrimitiveImportError_1.PrimitiveImportError.MISSING;
	            return false;
	        }
	        return true;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormValidationException_1 = __webpack_require__(21);
	var StructureProto = (function () {
	    ...
	    StructureProto.prototype.fill = function (object, data) {
	        ...
	        if (!form.importData(data)) {
	            throw new FormValidationException_1.FormValidationException(form.getErrors());
	        }
	        for (var name_1 in form.exportData()) {
	            object[name_1] = form.getValue(name_1);
	        }
	    };
	    return StructureProto;
	}());
	exports.StructureProto = StructureProto;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var PrimitiveString_1 = __webpack_require__(13);
	var Exceptions_1 = __webpack_require__(4);
	    ...
	    Form.prototype.importData = function (data) {
	        ...
	        for (var name_3 in this.primitives) {
	            if (data.hasOwnProperty(name_3)) {
	                var importResult = this.primitives[name_3].importValue(data[name_3]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PrimitiveInteger_1 = __webpack_require__(17);
	var Form_1 = __webpack_require__(14);
	var ServiceActionParams_1 = __webpack_require__(18);
	var ServiceActionReturn_1 = __webpack_require__(19);
	var ServiceAction_1 = __webpack_require__(20);
	var PrimitiveArray_1 = __webpack_require__(47);
	var PrimitiveStructure_1 = __webpack_require__(22);
	var Cat_1 = __webpack_require__(1);
	var TestService = (function (_super) {
	    ...
	    function TestService() {
	        _super.apply(this, arguments);
	        this.actions = {
	            'getList': function () { return new ServiceAction_1.ServiceAction('GET', '/list/:page', new ServiceActionParams_1.ServiceActionParams(new Form_1.Form({
	                'page': new PrimitiveInteger_1.PrimitiveInteger()
	            }), null, null), new ServiceActionReturn_1.ServiceActionReturn(new PrimitiveArray_1.PrimitiveArray()
	                .setPrimitive(new PrimitiveStructure_1.PrimitiveStructure()
	                .setProto(Cat_1.Cat.proto())))); }
	        };
	    }
	...
	var ServiceAction = (function () {
	    ...
	    ServiceAction.prototype.call = function (connector, params) {
	        ...
	        return connector.doRequest(request)
	            ...
	            if (_this.returns.primitive.importValue(response.body)) {
	                return _this.returns.primitive.getValue();
	            }
	            else {
	                throw new Exceptions_1.Exception(PrimitiveImportError_1.PrimitiveImportError[_this.returns.primitive.getError()]);
	            }
	        });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Exceptions_1 = __webpack_require__(4);
	var FormValidationException = (function (_super) {
	...
	exports.FormValidationException = FormValidationException;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Primitive_1 = __webpack_require__(9);
	var PrimitiveImportError_1 = __webpack_require__(10);
	var PrimitiveStructure = (function (_super) {
	    __extends(PrimitiveStructure, _super);
	    function PrimitiveStructure() {
	        _super.apply(this, arguments);
	    }
	    PrimitiveStructure.prototype.setProto = function (proto) {
	        this.proto = proto;
	        return this;
	    };
	    PrimitiveStructure.prototype.getProto = function () {
	        return this.proto;
	    };
	    PrimitiveStructure.prototype.importValue = function (data) {
	        this.value = this.proto.make(data);
	        return this.checkImportResult();
	    };
	    PrimitiveStructure.prototype.checkImportResult = function () {
	        if (!_super.prototype.checkImportResult.call(this)) {
	            return false;
	        }
	...
	exports.PrimitiveStructure = PrimitiveStructure;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AxiosServiceConnector = (function () {
	...
	exports.AxiosServiceConnector = AxiosServiceConnector;
