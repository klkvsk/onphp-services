...
class PhpStructureClassSourceCodeBuilder extends AbstractPhpSourceCodeBuilder
{
    ...
    public function build()
    {
        ...
        $cref = $this->classRef($s->getClassRef());
        $parentCref = $this->classRef($s->getClassRef())->addClassNamePrefix('Auto');
